...
// Production URL: http://169.239.251.102:341/~benjamin.charles/nyumbaConnect
// Localhost URL: http://localhost/nyumbaConnect (or http://localhost:8080/nyumbaConnect if using port 8080)
define('SITE_URL', 'http://169.239.251.102:341/~benjamin.charles/nyumbaConnect');
// define('SITE_URL', 'http://localhost/nyumbaConnect'); 

define('ADMIN_EMAIL', 'benjamincharles0440@gmail.com');

// Database Configuration
define('DB_HOST', 'localhost');

// Production Database (active for production)
define('DB_NAME', 'webtech_2025A_benjamin_charles');
define('DB_USER', 'benjamin.charles');
define('DB_PASS', 'Tapztq0440me#');
define('DB_CHARSET', 'utf8mb4');

// Local Database (commentedproduction)
// define('DB_USER', 'root');
// define('DB_PASS', '');
