...
if ($user_role === ROLE_STUDENT) {
    ...
    try {
        ...
        $requests = $db->fetchAll(
            "SELECT mr.*, u.name as alumni_name, u.education, u.skills, u.location 
             ...
             JOIN users u ON mr.alumni_id = u.user_id
             WHERE mr.student_id = ?
    ...
    // Get requests sent to this alumni
    try {
        $db = getDB();
        $requests = $db->fetchAll(
            ...
            <div class="card-body">
                <?php if (empty($requests)): ?>
                    <div class="text-center py-5">
                        ...
                        <?php else: ?>
                            <h4 class="mt-3 text-muted">No Mentorship Requests</h4>
                            <p class="text-muted">You haven't received any mentorship requests yet. Students will find you through your profile.</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <?php if ($request['status'] === MENTOR_STATUS_ACCEPTED): ?>
                                                    <a href="<?php echo SITE_URL; ?>/messages/thread.php?request_id=<?php echo $request['request_id']; ?>" 
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        <?php if ($user_role === ROLE_STUDENT): ?>
                                                            Mentorship Request to <?php echo sanitizeInput($request['alumni_name']); ?>
                                                        <?php else: ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <?php if ($user_role === ROLE_STUDENT): ?>
                                                                ...
                                                                <p><strong>Name:</strong> <?php echo sanitizeInput($request['alumni_name']); ?></p>
                                                                ...
                                                                <?php if (!empty($request['location'])): ?>
                                                                    <p><strong>Location:</strong> <?php echo sanitizeInput($request['location']); ?></p>
                                                                <?php endif; ?>
                                                            <?php else: ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <?php if ($request['responded_at']): ?>
                                                                <p><strong>Responded:</strong> <?php echo formatDateTime($request['responded_at']); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
