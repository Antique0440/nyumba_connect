        ...
        switch ($action) {
            ...
            case 'delete_user':
                ...
                if ($total_dependencies > 0) {
                    ...
                    $db->execute(
                        "UPDATE users SET is_active = 0, email = CONCAT(email, '_deleted_', UNIX_TIMESTAMP()) WHERE user_id = ?",
                        [$user_id]
                    );
...
try {
    ...
    $users_query = "SELECT user_id, name, email, role, year_left, location, is_active, created_at 
